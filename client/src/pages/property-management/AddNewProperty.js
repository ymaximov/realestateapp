...
import { Form, Col, Row, Input, Button, Tabs } from "antd";
  ...
  return (
    <Layout>
      ...
      <Form layout="vertical">
        <Tabs>
          <Tabs.TabPane tab="Property Details" key={0}>
            <Row>
            ...
            <Row gutter={20}>
              ...
              <Col span={8} xs={240} s={24} lg={8}>
                <Form.Item
                  ...
                  rules={[{ require: false }]}
                >
                  <Input placeholder="Floor Number"></Input>
                </Form.Item>
              </Col>
              <Col span={8} xs={240} s={24} lg={8}>
                <Form.Item
              ...
              <Col>
                ...
                Select from dropdown
                  ...
                  <select className="bp-type" name="property-type">
                    ...
                    <option value="co-op">Apartment (Co-Op)</option>
              ...
              <Col>
                <Form.Item
                  ...
                  rules={[{ require: true }]}
                >
                  <select className="bp-type" name="bedrooms">
              ...
              <Col>
                <Form.Item
                  ...
                  rules={[{ require: true }]}
                >
                  <select className="bp-type" name="bathrooms">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
          ...
          <Tabs.TabPane tab="Amenities" key={1}>
            <Row gutter={20}>
              <Col span={8} xs={240} s={24} lg={8}>
                <Form.Item
                  required
